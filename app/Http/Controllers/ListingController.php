...
class ListingController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $request->validate([
            ...
            'price_per_m2' => 'required|numeric|min:0.1|max:10000',
            ...
            'price_per_m2.required' => 'Vui lòng nhập đơn giá /m² (theo đơn vị triệu đồng/m²)',
            'price_per_m2.min' => 'Đơn giá /m² phải lớn hơn 0,1 triệu đồng/m²',
            'price_per_m2.max' => 'Đơn giá /m² không được vượt quá 10.000 triệu đồng/m² (10 tỉ/m²)',
            'area.required' => 'Vui lòng nhập diện tích',
            'area.min' => 'Diện tích phải lớn hơn 1m²',
            'area.max' => 'Diện tích không được vượt quá 1.000.000m²',
        ...
        try {
            ...
            $listing = Listing::create([
                ...
                'price' => $price, // Giá tổng (đồng) - đã tính từ đơn giá/m² hoặc từ giá nhập
                'price_per_m2' => $pricePerM2, // Đơn giá/m² (đồng/m²)
                'area' => $request->area,
